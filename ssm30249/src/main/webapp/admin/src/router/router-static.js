...
import center from '@/views/center'
    ...
    import zhunongxinxi from '@/views/modules/zhunongxinxi/list'
    ...
    import nongchanpinjiandu from '@/views/modules/nongchanpinjiandu/list'
...
const routes = [{
	...
	path: '/huiyuan',
      ...
      ,{
	path: '/nongchanpinjiandu',
        name: '农产品监督',
        component: nongchanpinjiandu
      }
      ,{
	path: '/config',
        name: '轮播图管理',
